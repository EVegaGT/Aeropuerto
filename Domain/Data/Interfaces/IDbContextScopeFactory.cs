...
namespace Domain.Data.Interfaces
{
    ...
    public interface IDbContextScopeFactory
    {
        ...
        /// </summary>
        IDbContextScope Create(string connectionString = null, DbContextScopeOption joiningOption = DbContextScopeOption.JoinExisting);
        ...
        /// implications of doing this.
        /// </summary>
        IDbContextReadOnlyScope CreateReadOnly(string connectionString = null, DbContextScopeOption joiningOption = DbContextScopeOption.JoinExisting);
        ...
        /// </summary>
        IDbContextScope CreateWithTransaction(IsolationLevel isolationLevel, string connectionString = null);
        ...
        /// and only if you fully understand the implications of doing this.
        /// </summary>
        IDbContextReadOnlyScope CreateReadOnlyWithTransaction(IsolationLevel isolationLevel, string connectionString = null);

        /// <summary>
        /// Creates a new DbContextScope with AutoDetectChanges off.
        /// 
        /// By default, the new scope will join the existing ambient scope. This
        /// is what you want in most cases. This ensures that the same DbContext instances
        /// are used by all services methods called within the scope of a business transaction.
        ...
        /// implications of doing this.
        /// </summary>
        IDbContextScope CreateWithoutAutoDetectChanges(string connectionString = null, DbContextScopeOption joiningOption = DbContextScopeOption.JoinExisting);
